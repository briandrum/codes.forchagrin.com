...
4. _(d)_ Best Management Practices (BMPs): Also STORMWATER CONTROL MEASURE (SCM).
...
9. _(i)_ Development area: A parcel or contiguous parcels owned by one person
...
27. _(aa)_ National Pollutant Discharge Elimination System (NPDES): The
...
sediment pollution.
51. _(yy)_ Soil & water conservation district: An entity organized under Chapter 1515 of the Ohio Revised Code referring to either the Soil and Water
...
point.
65. _(mmm)_ Wetland: Those areas, that are inundated or saturated by surface
...
4. _(d)_ Soil disturbing activities shall not begin and zoning permits shall
...
regulation.
2. _(b)_ Best Management Practices (BMPs) and Stormwater Control Measures (SCMs) adequate
...
Ohio EPA NPDES Construction General Permit is acceptable).
    3. _(3)_ Site description:  The SWP3 shall provide:
        1. _(A)_ A description of the nature and type of the construction activity
(e.g. residential, shopping mall, highway, etc.).
...
including off-site borrow areas).
        3. _(C)_ An estimate of the impervious area and percent of imperviousness
...
construction and post-construction site conditions.
        5. _(E)_ Existing data describing the soil and, if available, the quality
...
from previous contamination caused by prior land uses.
        ...
        7. _(G)_ An implementation schedule which describes the sequence of major
...
drainage ways, and riparian zones.
        11. _(K)_ Location and description of any stormwater discharges associated
...
designated with an individual identification number.
        14. _(N)_ Site map showing:
            1. _(i)_ Limits of soil-disturbing activity of the site, including off
...
grading activities as well as the size of each drainage watershed in acres.
            4. _(iv)_ Surface water locations including springs, wetlands, streams,
...
facilities, and utilities.
            6. _(vi)_ The location of all erosion and sediment control, including
...
sediment settling volume and the maximum expected disturbed area that will be
...
other relevant parameters for each practice.
            9. _(ix)_ A separate plan and profile view of each individual sediment
settling pond and its outlet structure. Detail drawings of the outlet
structure shall indicate the following elevations:
                1. _(a)_ Pond bottom
                2. _(b)_ Elevation required to store the required sediment storage
volume
                3. _(c)_ For sediment basins, the elevation at which the skimmer is
attached
                4. _(d)_ For sediment traps, the top and bottom of the stone outlet
section
...
exclusive of the sediment storage volume
            ...
            10. _(x)_ Where used as a sediment-settling pond during construction,
...
of the permanent storm water basin with the following information specified:
                1. _(a)_ Storage volume provided below the elevation at which the
skimmer or other surface dewatering device is attached
                2. (b Elevation at which the skimmer or other surface dewatering
device is attached
                3. _(c)_ Elevation at which the full dewatering zone is stored above
the skimmer invert
                4. _(d)_ Any temporary modification to permanent outlet orifices or
...
where the vehicles will ingress and egress the construction site.
            17. _(xvii)_ The location of any in-stream activities including stream
crossings.
...
erodibility of existing soils.
        2. _(B)_ If applicable, data regarding the nature, distribution, strength,
...
protection.
    7. _(7)_ Off-site tracking of sediment and dust control. Best Management Practices
...
following:
        1. _(A)_ Construction entrances shall be built and shall serve as the only
...
edition of Rainwater and Land Development.
        2. _(B)_ Streets and catch basins adjacent to construction entrances shall
...
settling pond, or to a sump pump for dewatering in conformance with Section 1355.09 (g) of this regulation. No surfactants or detergents may be used to
wash vehicles.
...
the most recent edition of Rainwater and Land Development.
        2. _(B)_ Structural practices shall be designated and implemented on site
...
construction.
        6. _(F)_ Construction of bridges, culverts, or sediment control structures
...
implement site best management to prevent toxic materials, hazardous materials,
...
waste materials.
        2. _(B)_ Concrete Truck Wash Out: The washing of concrete material into a
...
inches, and whether any discharges occurred.
        4. _(D)_ Weather information and a description of any discharges occurring
at the time of inspection.
        5. _(E)_ Locations of:
            ...
            3. _(3)_ BMPs that failed to operate as designed or proved inadequate
for a particular location.
            4. _(4)_ Where additional BMPs are needed that did not exist at the
time of inspection.
        6. _(F)_ Corrective action required including any necessary changes to the
...
these streets nearest to the construction entrances shall be cleaned weekly.
    4. _(4)_ Stabilization. The development area shall be stabilized as
detailed in Table 4.
...
amended and the new must be installed within ten (10) days of the inspection.
        3. _(C)_ When BMPs depicted on the Abbreviated SWP3 are not installed. If
...
and fill activity.
2. _(b)_ All development areas may be subject to external inspections by
...
9. _(i)_ The Village Engineer shall notify the U.S. Army Corps of Engineers
