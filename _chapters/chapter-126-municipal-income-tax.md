...
Add together the percentages determined in accordance with Section 126.0701(a),
(b) and (c) or such of the aforesaid percentages as are applicable to the
...
profits from business activities under Section 126.0501(c), (d) and (e), only if
and to the extent that the rental, ownership, management or operation of the
real estate from which such rentals are derived (whether so rented, managed or
