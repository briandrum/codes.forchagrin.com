...
544.13   Permit; bond; contractor’s license.
...
1. {% comment -%} (a) {%- endcomment -%} Such owner shall trim or cause to be trimmed such tree, plant or
...
2. {% comment -%} (b) {%- endcomment -%} Such owner shall trim or remove, as the case may require, every dead,
decayed or broken tree, plant or shrubbery, or part thereof, so that the same
shall not fall to the street or sidewalk.
3. {% comment -%} (c) {%- endcomment -%} Such owner shall cut down and remove any tree, plant or shrubbery, or
...
exceeding a height of 12 inches.    (Ord. 2019-43.  Passed 7-8-19.)
...
1. {% comment -%} (a) {%- endcomment -%} The following is a list of trees, the planting of which may be
...
2. {% comment -%} (b) {%- endcomment -%} Wherever and whenever the Chief Administrative Officer determines
...
3. {% comment -%} (c) {%- endcomment -%} It is hereby determined that whenever any new construction is
...
1. {% comment -%} (a) {%- endcomment -%} No person shall hereafter plant any tree in a public place or street
...
   
2. {% comment -%} (b) {%- endcomment -%} Each permit shall be valid for a period of thirty days from the date
...
3. {% comment -%} (c) {%- endcomment -%} No permits will be issued without also providing a commercial general
...
1. {% comment -%} (a) {%- endcomment -%} (1)   There is hereby created a commission to be known as the “Shade
...
Village.
    2. {% comment -%} (2) {%- endcomment -%} The term of the members of the Commission appointed by the Mayor
...
(Ord. 2018-26.  Passed 6-11-18.)
    3. {% comment -%} (3) {%- endcomment -%} Members of the Commission shall serve without compensation.
2. {% comment -%} (b) {%- endcomment -%} The Shade Tree Commission shall have the power to study, investigate,
