...
1. {% comment -%} (a) {%- endcomment -%} Scope. This chapter is designed to provide minimum standards for the
abatement of pollution of the air resources of the Municipality.
2. {% comment -%} (b) {%- endcomment -%} Violations. No person, firm or corporation shall commit any act in
...
1. {% comment -%} (a) {%- endcomment -%} Permit to Operate. On and after October 15, 1968, all devices or
...
2. {% comment -%} (b) {%- endcomment -%} Violation of Chapter. Whenever any device is found to be operated in
...
3. {% comment -%} (c) {%- endcomment -%} Sealed Devices. It shall be a violation of this chapter to operate any
...
4. {% comment -%} (d) {%- endcomment -%} Denial of Admittance. No person shall deny admittance during business
...
5. {% comment -%} (e) {%- endcomment -%} Right to Appeal. The right to appeal any order or decision made under
...
1. {% comment -%} (a) {%- endcomment -%} Permit Requirements. No person shall erect, construct, alter or
...
is issued.
2. {% comment -%} (b) {%- endcomment -%} Time Limitations. If construction for which a permit has been issued
...
3. {% comment -%} (c) {%- endcomment -%} Inspection. The Environmental Control Officer shall inspect every
...
Control Officer.
4. {% comment -%} (d) {%- endcomment -%} Exceptions. Nothing in subsections (a) through (c) hereof shall be
...
Exceptions:
    1. {% comment -%} (1) {%- endcomment -%}  During equipment breakdown.
    2. {% comment -%} (2) {%- endcomment -%}  During initial firing from complete shutdown.
2. {% comment -%} (b) {%- endcomment -%} Gases, Fumes and Other Pollution. No emission of poisonous, obnoxious,
...
3. {% comment -%} (c) {%- endcomment -%} Dust or Fumes. No emission with color other than black is to be
...
4. {% comment -%} (d) {%- endcomment -%} Settleable Particulates. This includes materials classified as fly
...
1. {% comment -%} (a) {%- endcomment -%} Dust. No person, firm or corporation having charge or management of
...
2. {% comment -%} (b) {%- endcomment -%} Open Fires. No owner, occupant or person in charge, by himself, his
...
3. {% comment -%} (c) {%- endcomment -%} Exceptions.
    1. {% comment -%} (1) {%- endcomment -%} Open fires shall be permitted for recreational purposes.
    2. {% comment -%} (2) {%- endcomment -%} Open fires may be permitted if they are in accordance with
...
1. {% comment -%} (a) {%- endcomment -%} Construction. Every combustion or other device hereafter erected,
...
this chapter.
2. {% comment -%} (b) {%- endcomment -%} Maintenance. Every combustion device shall be so equipped and
...
1. {% comment -%} (a) {%- endcomment -%} Qualification of Environmental Control Officer. The Environmental
...
engineering.
2. {% comment -%} (b) {%- endcomment -%} Test Procedure; Smoke. Optical density measurements shall be used for
...
the test period.
3. {% comment -%} (c) {%- endcomment -%} Authorization of Testing. When the Environmental Control Officer has
...
4. {% comment -%} (d) {%- endcomment -%} Test Procedures. The Environmental Control Officer and owner shall
...
in the State.
5. {% comment -%} (e) {%- endcomment -%} Cost of Tests. If the results of the tests indicate that the device is
