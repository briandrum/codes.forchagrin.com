...
1. {% comment -%} (a) {%- endcomment -%} Within the districts established by this Planning and Zoning Code and
...
2. {% comment -%} (b) {%- endcomment -%} It is the intent of this Code to permit such nonconformities to
...
3. {% comment -%} (c) {%- endcomment -%} It is further the intent that nonconformities shall not be enlarged
...
4. {% comment -%} (d) {%- endcomment -%} Furthermore, the continuation of a lawful nonconformity shall not be
...
1. {% comment -%} (a) {%- endcomment -%} Maintenance and Repair. A nonconforming building or other structure
...
located.
2. {% comment -%} (b) {%- endcomment -%} Additions. A nonconforming building or other structure shall not be
...
3. {% comment -%} (c) {%- endcomment -%} Moving. A nonconforming building shall not be moved in whole or in
...
4. {% comment -%} (d) {%- endcomment -%} Restoration of Damaged Building. If a nonconforming building is
...
1. {% comment -%} (a) {%- endcomment -%} Change of Use. The nonconforming use of a building may only be changed
...
single use category
2. {% comment -%} (b) {%- endcomment -%} Expansion of Use. A nonconforming use of part of a building may only
...
3. {% comment -%} (c) {%- endcomment -%} Discontinuance of Use. If a nonconforming use within a building or
...
located.
4. {% comment -%} (d) {%- endcomment -%} Nonconforming Signs. Signs lawfully erected but made nonconforming by
...
signs.
5. {% comment -%} (e) {%- endcomment -%} Nonconforming Parking Facilities. A building or use existing lawfully
...
6. {% comment -%} (f) {%- endcomment -%} Nonconforming as to Performance Standards. A building or use existing
...
1. {% comment -%} (a) {%- endcomment -%} Expansion of Use. The nonconforming use of a lot, or part thereof,
shall not be expanded or extended onto other parts of the lot.
2. {% comment -%} (b) {%- endcomment -%} Discontinuance of Use. If the nonconforming use of a lot, or part
...
3. {% comment -%} (c) {%- endcomment -%} Insufficient Size. A vacant lot of record which does not comply with
...
may be used as follows:
    1. {% comment -%} (1) {%- endcomment -%} Single lots. If a vacant nonconforming lot does not adjoin another
...
and Zoning Code except those pertaining to lot width and area.
    2. {% comment -%} (2) {%- endcomment -%} Lots in combination. If a vacant nonconforming lot adjoins one or
...
1. {% comment -%} (a) {%- endcomment -%} The foregoing provisions of this chapter shall also apply to the
...
2. {% comment -%} (b) {%- endcomment -%} Buildings and uses that were conforming or lawfully existing
...
1. {% comment -%} (a) {%- endcomment -%} A nonconforming building or use shall cease to be considered as such
whenever it complies with the requirements of the district in which it is
located and shall not be resumed thereafter.
2. {% comment -%} (b) {%- endcomment -%} A proposed building conforming in all respects to the Planning and
