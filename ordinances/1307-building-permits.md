...
1. {% comment -%} (a) {%- endcomment -%} Before proceeding with the installation, construction or excavation
...
Building Code.
2. {% comment -%} (b) {%- endcomment -%} Before a swimming pool permit is issued, a plot plan shall be
...
3. {% comment -%} (c) {%- endcomment -%} (Editor’s note: Former subsection (c) was repealed by Ordinance 2019-
...
1. {% comment -%} (a) {%- endcomment -%} The existing elevation of the center line of the street;
2. {% comment -%} (b) {%- endcomment -%} The existing elevation of the top of the nearest street curb, if any;
3. {% comment -%} (c) {%- endcomment -%} The existing elevation of the top of the nearest portion of the
sidewalk, if any;
4. {% comment -%} (d) {%- endcomment -%} The existing elevation at each corner of the lot;
5. {% comment -%} (e) {%- endcomment -%} The first or main floor elevation and location of adjacent buildings
within 150 feet;
6. {% comment -%} (f) {%- endcomment -%} The elevations of the proposed finished grade of the lot on a
suitable contour interval;
7. {% comment -%} (g) {%- endcomment -%} The proposed elevation of the first or main floor of the building and
lawn grade at the building corners;
8. {% comment -%} (h) {%- endcomment -%} The foundation and/or slab elevation;
9. {% comment -%} (i) {%- endcomment -%} The bearings and lot dimensions, the lot and block number or lot and
tract number, an arrow showing the north direction and the street name;
10. {% comment -%} (j) {%- endcomment -%} A reference bench mark established on some permanent object in the
...
11. {% comment -%} (k) {%- endcomment -%} The location and elevation of all existing and proposed sanitary
sewers, water lines and storm sewers within or adjacent to the lot; and
12. {% comment -%} (l) {%- endcomment -%} Any other information that may be required by the Municipal Engineer
...
1. {% comment -%} (a) {%- endcomment -%} Grade plan fee for single-family residential construction: two
hundred fifty dollars ($250.00).
2. {% comment -%} (b) {%- endcomment -%} Grade plan fee for multi-family construction: two hundred fifty
dollars ($250.00) per living unit.
3. {% comment -%} (c) {%- endcomment -%} Grade plan fee for commercial and industrial construction: actual
cost incurred.  
...
2. {% comment -%} (b) {%- endcomment -%} The Chief Administrative Officer shall create one or more forms to be
...
area variances found in Section 1111.07(c) of the Planning and Zoning Code.
    2. {% comment -%} (2) {%- endcomment -%} Whenever the appeal relates to seeking a variance from required
construction materials or methods, the standard of review shall be as follows:
        1. {% comment -%} (A) {%- endcomment -%} The variance was not self-created.
        2. {% comment -%} (B) {%- endcomment -%} Relief will not violate the spirit of the Building Code.
        3. {% comment -%} (C) {%- endcomment -%} The requested variance is the minimum necessary to avoid an
unnecessary hardship.
        4. {% comment -%} (D) {%- endcomment -%} Relief will not compromise or reduce (i) the health or safety of
...
4. {% comment -%} (d) {%- endcomment -%} Whenever an appeal is taken to the Board of Zoning Appeals from a
...
record. 
5. {% comment -%} (e) {%- endcomment -%} Advice of Expert on Economic Feasibility.  If, in reviewing a request
