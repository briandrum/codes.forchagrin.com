...
1. {% comment -%} (a) {%- endcomment -%} "Canvasser" means traveling from residence to residence within the
...
2. {% comment -%} (b) {%- endcomment -%} "Chief of Police" includes the designee of the Chief of Police.
3. {% comment -%} (c) {%- endcomment -%} "Peddler" means any person traveling, by foot, automobile, truck or
...
1. {% comment -%} (a) {%- endcomment -%} No Peddler may peddle within the Village without holding a valid
...
2. {% comment -%} (b) {%- endcomment -%} The following individuals shall not be required to obtain a license:
    1. {% comment -%} (1) {%- endcomment -%} Children under the age of eighteen (18);
    2. {% comment -%} (2) {%- endcomment -%} Newspaper carriers seeking customers for a newspaper which he or
she regularly delivers or intends to regularly deliver; and
    3. {% comment -%} (3) {%- endcomment -%} Canvassers.  
...
1. {% comment -%} (a) {%- endcomment -%} Name, age and physical description of the applicant and provide a
valid photographic identification card;
2. {% comment -%} (b) {%- endcomment -%} Date of birth of applicant;
3. {% comment -%} (c) {%- endcomment -%} Complete permanent and local address of applicant;
4. {% comment -%} (d) {%- endcomment -%} Name and address of the person, firm, corporation or association for
...
three (3) years;
5. {% comment -%} (e) {%- endcomment -%} A description of the nature of the business and the goods, services
...
6. {% comment -%} (f) {%- endcomment -%} The proposed dates and times of the peddling and the routes to be
followed in conducting same;
7. {% comment -%} (g) {%- endcomment -%} Whether the applicant or business has ever been denied a license or
...
8. {% comment -%} (h) {%- endcomment -%} Whether the applicant has ever been convicted of a felony violation;
...
1. {% comment -%} (a) {%- endcomment -%} The applicant has made a false, misleading or deceptive statement in
providing the information required under Section 711.04;
2. {% comment -%} (b) {%- endcomment -%} The applicant has been convicted of a felony violation, a misdemeanor
...
past five (5) years.
3. {% comment -%} (c) {%- endcomment -%} Each applicant who is issued a license shall carry the license
...
1. {% comment -%} (a) {%- endcomment -%} No person shall peddle or canvass except between the hours of 9:00
a.m. and the later of sunset or 9 P.M.
2. {% comment -%} (b) {%- endcomment -%} No Peddler or Canvasser shall enter or attempt to enter the house,
...
3. {% comment -%} (c) {%- endcomment -%} No Peddler shall engage in or transact any type of business or
solicitation other than as specified on the license application.
4. {% comment -%} (d) {%- endcomment -%} No license issued hereunder shall be assigned or transferred to any
other person.
5. {% comment -%} (e) {%- endcomment -%} No person licensed pursuant to this chapter shall have any exclusive
...
6. {% comment -%} (f) {%- endcomment -%} No person shall knock at the door or ring the doorbell of any
...
1. {% comment -%} (a) {%- endcomment -%} It is subsequently determined that the licensee provided false,
misleading or deceptive information in completing the application form set
forth in Section 711.04.
2. {% comment -%} (b) {%- endcomment -%} The licensee has been convicted of a felony violation or misdemeanor
violation involving moral turpitude or an offense of violence.
3. {% comment -%} (c) {%- endcomment -%} The licensee has been convicted of a violation of any provision of
this chapter.
4. {% comment -%} (d) {%- endcomment -%} The licensee solicits in an unlawful manner or in such a manner as to
constitute a menace to the health, safety or general welfare of the public.
5. {% comment -%} (e) {%- endcomment -%} Violates any of the provisions of this Chapter 711.  
