...
5. {% comment -%} (e) {%- endcomment -%} "Development area" means a tract of land that may consist of a single
...
12. {% comment -%} (l) {%- endcomment -%} "Street frontage" means the horizontal distance of a lot measured
