...
1. {% comment -%} (a) {%- endcomment -%} Hazardous zones, commonly called "no passing zones," shall consist of
...
1. {% comment -%} (a) {%- endcomment -%} Whenever any roadway has been divided into two or more clearly marked
