...
1. {% comment -%} (a) {%- endcomment -%} "Sexual conduct" means vaginal intercourse between a male and female;
...
2. {% comment -%} (b) {%- endcomment -%} "Sexual contact" means any touching of an erogenous zone of another,
...
3. {% comment -%} (c) {%- endcomment -%} "Sexual activity" means sexual conduct or sexual contact, or both.
4. {% comment -%} (d) {%- endcomment -%} "Prostitute" means a male or female who promiscuously engages in
sexual activity for hire, regardless of whether the hire is paid to the
prostitute or to another.
5. {% comment -%} (e) {%- endcomment -%} “Harmful to juveniles” means that quality of any material or
...
following apply:
    1. {% comment -%} (1) {%- endcomment -%} The material or performance, when considered as a whole, appeals to
the prurient interest of juveniles in sex.
    2. {% comment -%} (2) {%- endcomment -%} The material or performance is patently offensive to prevailing
standards in the adult community as a whole with respect to what is suitable
for juveniles.
    3. {% comment -%} (3) {%- endcomment -%} The material or performance, when considered as a whole, lacks
serious literary, artistic, political and scientific value for juveniles.
6. {% comment -%} (f) {%- endcomment -%} When considered as a whole, and judged with reference to ordinary
...
performance is "obscene" if any of the following apply:
    1. {% comment -%} (1) {%- endcomment -%} Its dominant appeal is to prurient interest;
    2. {% comment -%} (2) {%- endcomment -%} Its dominant tendency is to arouse lust by displaying or depicting
...
to represent human beings as mere objects of sexual appetite;
    3. {% comment -%} (3) {%- endcomment -%} Its dominant tendency is to arouse lust by displaying or depicting
bestiality or extreme or bizarre violence, cruelty or brutality;
    4. {% comment -%} (4) {%- endcomment -%} Its dominant tendency is to appeal to scatological interest by
...
purpose;
    5. {% comment -%} (5) {%- endcomment -%} It contains a series of displays or descriptions of sexual
...
artistic purpose.
7. {% comment -%} (g) {%- endcomment -%} "Sexual excitement" means the condition of human male or female
genitals when in a state of sexual stimulation or arousal.
8. {% comment -%} (h) {%- endcomment -%} "Nudity" means the showing, representation or depiction of human male
...
9. {% comment -%} (i) {%- endcomment -%} "Juvenile" means an unmarried person under the age of eighteen.
10. {% comment -%} (j) {%- endcomment -%} "Material" means any book, magazine, newspaper, pamphlet, poster,
...
11. {% comment -%} (k) {%- endcomment -%} "Performance" means any motion picture, preview, trailer, play, show,
skit, dance or other exhibition performed before an audience.
12. {% comment -%} (l) {%- endcomment -%} "Spouse" means a person married to an offender at the time of an
alleged offense, except that such person shall not be considered the spouse
when any of the following apply:
    1. {% comment -%} (1) {%- endcomment -%} When the parties have entered into a written separation agreement
authorized by Ohio R.C. 3103.06;
    2. {% comment -%} (2) {%- endcomment -%} During the pendency of an action between the parties for annulment,
divorce, dissolution of marriage or legal separation;
    3. {% comment -%} (3) {%- endcomment -%} In the case of an action for legal separation, after the effective
date of the judgment for legal separation.
13. {% comment -%} (m) {%- endcomment -%} "Minor" means a person under the age of eighteen years.
14. {% comment -%} (n) {%- endcomment -%} “Mental health client or patient” has the same meaning as in Ohio R.C.
2305.51.
15. {% comment -%} (o) {%- endcomment -%} “Mental health professional” has the same meaning as in Ohio R.C.
2305.115.
16. {% comment -%} (p) {%- endcomment -%} “Sado-masochistic abuse” means flagellation or torture by or upon a
...
1. {% comment -%} (a) {%- endcomment -%} An owner or manager, or agent or employee of an owner or manager, of a
...
2. {% comment -%} (b) {%- endcomment -%} Without limitation on the manner in which such notice may be given,
...
3. {% comment -%} (c) {%- endcomment -%} Section 533.11 does not apply to a motion picture operator or projectionist acting
...
connection.
    2. {% comment -%} (2) {%- endcomment -%} Subsection (d)(1) of this section does not apply to a person who
...
nature.
    3. {% comment -%} (3) {%- endcomment -%} Subsection (d)(1) of this section does not apply to a person who
...
5. {% comment -%} (e) {%- endcomment -%} An employer is not guilty of a violation of Section 533.11,
533.12, or
...
employment or agency, and the employer does either of the following:
    1. {% comment -%} (1) {%- endcomment -%} With knowledge of the employee’s or agent’s conduct, the employer
authorizes or ratifies the conduct.
    2. {% comment -%} (2) {%- endcomment -%} The employer recklessly disregards the employee’s or agent’s
conduct.
6. {% comment -%} (f) {%- endcomment -%} It is an affirmative defense to a charge under Section 533.11 or
...
7. {% comment -%} (g) {%- endcomment -%} If any provision of this section, or the application of any provision
...
1. {% comment -%} (a) {%- endcomment -%} No person, who is eighteen years of age or older, shall engage in
...
2. {% comment -%} (b) {%- endcomment -%} Whoever violates this section is guilty of unlawful sexual conduct
...
1. {% comment -%} (a) {%- endcomment -%} No person shall have sexual contact with another, not the spouse of
...
when any of the following applies:
    1. {% comment -%} (1) {%- endcomment -%} The offender knows that the sexual contact is offensive to the
other person, or one of the other persons, or is reckless in that regard.
    2. {% comment -%} (2) {%- endcomment -%} The offender knows that the other person’s or one of the other
...
touching person’s conduct is substantially impaired.
    3. {% comment -%} (3) {%- endcomment -%} The offender knows that the other person or one of the other
persons submits because of being unaware of the sexual contact.
    4. {% comment -%} (4) {%- endcomment -%} The other person or one of the other persons is thirteen years of
...
age and four or more years older than such other person.
    5. {% comment -%} (5) {%- endcomment -%} The offender is a mental health professional, the other person or
...
2. {% comment -%} (b) {%- endcomment -%} No person shall be convicted of a violation of this section solely
upon the victim’s testimony unsupported by other evidence.
3. {% comment -%} (c) {%- endcomment -%} Whoever violates this section is guilty of sexual imposition, a
...
1. {% comment -%} (a) {%- endcomment -%} No person, for the purpose of sexually arousing or gratifying the
...
2. {% comment -%} (b) {%- endcomment -%} No person, for the purpose of sexually arousing or gratifying the
person’s self, shall commit trespass or otherwise surreptitiously invade the
privacy of another to videotape, film, photograph, or otherwise record the
other person in a state of nudity.
3. {% comment -%} (c) {%- endcomment -%} No person shall secretly or surreptitiously videotape, film,
...
4. {% comment -%} (d) {%- endcomment %}
    ...
    2. {% comment -%} (2) {%- endcomment -%} A violation of subsection (a) hereof is a misdemeanor of the third
degree.
    3. {% comment -%} (3) {%- endcomment -%} A violation of subsection (b) hereof is a misdemeanor of the second
degree.
    4. {% comment -%} (4) {%- endcomment -%} A violation of subsection (c) hereof is a misdemeanor of the first
degree.  (ORC 2907.08)
...
1. {% comment -%} (a) {%- endcomment -%} No person shall recklessly do any of the following, under
...
members of the person’s household:
    1. {% comment -%} (1) {%- endcomment -%} Expose the person’s private parts;
    2. {% comment -%} (2) {%- endcomment -%} Engage in sexual conduct or masturbation;
    3. {% comment -%} (3) {%- endcomment -%} Engage in conduct that to an ordinary observer would appear to be
sexual conduct or masturbation.
2. {% comment -%} (b) {%- endcomment -%} No person shall knowingly do any of the following, under circumstances
...
not the spouse of the offender:
    1. {% comment -%} (1) {%- endcomment -%} Engage in masturbation;
    2. {% comment -%} (2) {%- endcomment -%} Engage in sexual conduct;
    3. {% comment -%} (3) {%- endcomment -%} Engage in conduct that to an ordinary observer would appear to be
sexual conduct or masturbation;
    4. {% comment -%} (4) {%- endcomment -%} Expose the person’s private parts with the purpose of personal
...
section.
    2. {% comment -%} (2) {%- endcomment -%} Except as otherwise provided in subsection (c)(2) of this section,
...
was a minor, a felony which shall be prosecuted under appropriate state law.
    3. {% comment -%} (3) {%- endcomment -%} Except as otherwise provided in subsection (c)(3) of this section,
...
this section is a felony and shall be prosecuted under appropriate state law.
    5. {% comment -%} (5) {%- endcomment -%} A violation of subsection (b)(4) of this section is a misdemeanor
...
section:
        1. {% comment -%} (A) {%- endcomment -%} The offender is less than ten years older than the other person.
        2. {% comment -%} (B) {%- endcomment -%} The offender is ten or more years older than the other person and
the offender has not previously been convicted of or pleaded guilty to any
violation of this section.
    2. {% comment -%} (2) {%- endcomment -%} If the offender is convicted of or pleads guilty to a violation of
...
1. {% comment -%} (a) {%- endcomment -%} No person, knowingly and for gain, shall do either of the following:
    1. {% comment -%} (1) {%- endcomment -%} Entice or solicit another to patronize a prostitute or brothel;
    2. {% comment -%} (2) {%- endcomment -%} Procure a prostitute for another to patronize, or take or direct
another at his or her request to any place for the purpose of patronizing a
prostitute.
2. {% comment -%} (b) {%- endcomment -%} No person, having authority or responsibility over the use of
premises, shall knowingly permit such premises to be used for the purpose of
engaging in sexual activity for hire.
3. {% comment -%} (c) {%- endcomment -%} Whoever violates subsection (a) or (b) of this section is guilty of
...
4. {% comment -%} (d) {%- endcomment -%} No person shall recklessly induce, entice, or procure another to
engage in sexual activity for hire in exchange for the person giving anything
of value to the other person.
5. {% comment -%} (e) {%- endcomment -%} As used in subsection (d) of this section, “Sexual Activity for Hire”
...
such person.
6. {% comment -%} (f) {%- endcomment -%} Whoever violates subsection (d) of this section is guilty of engaging
...
1. {% comment -%} (a) {%- endcomment -%} No person shall knowingly solicit another to engage in sexual activity
for hire in exchange for the person receiving anything of value from the other
person.
2. {% comment -%} (b) {%- endcomment -%} No person, with knowledge that the person has tested positive as a
...
3. {% comment -%} (c) {%- endcomment -%} As used in subsection (a) of this section, “Sexual Activity for Hire”
means an implicit or explicit agreement to provide sexual activity in exchange
for anything of value paid to the person engaging in such sexual activity, to
any person trafficking that person, or to any person associated with either
such person.
4. {% comment -%} (d) {%- endcomment -%} (1)    Whoever violates subsection (a) of this section is guilty of
soliciting. Soliciting is a misdemeanor of the third degree.
    2. {% comment -%} (2) {%- endcomment -%} Whoever violates subsection (b) of this section is guilty of
...
1. {% comment -%} (a) {%- endcomment -%} No person, with purpose to solicit another to engage in sexual
activity for hire and while in or near a public place, shall do any of the
following:
    1. {% comment -%} (1) {%- endcomment -%} Beckon to, stop or attempt to stop another;
    2. {% comment -%} (2) {%- endcomment -%} Engage or attempt to engage another in conversation;
    3. {% comment -%} (3) {%- endcomment -%} Stop or attempt to stop the operator of a vehicle or approach a
stationary vehicle;
    4. {% comment -%} (4) {%- endcomment -%} If the offender is the operator of or a passenger in a vehicle,
...
the offender is the passenger;
    5. {% comment -%} (5) {%- endcomment -%} Interfere with the free passage of another.
2. {% comment -%} (b) {%- endcomment -%} No person, with knowledge that the person has tested positive as a
carrier of a virus that causes acquired immunodeficiency syndrome, shall engage
in conduct in violation of subsection (a) of this section.
3. {% comment -%} (c) {%- endcomment -%} As used in subsection (a) of this section:
    1. {% comment -%} (1) {%- endcomment -%} “Public Place”.  Means any of the following:
        1. {% comment -%} (A) {%- endcomment -%} A street, road, highway, thoroughfare, bikeway, walkway,
sidewalk, bridge, alley, alleyway, plaza, park, driveway, parking lot or
transportation facility.
        2. {% comment -%} (B) {%- endcomment -%} A doorway or entrance way to a building that fronts on a place
described in subsection (c)(1)A.  of this definition.
        3. {% comment -%} (C) {%- endcomment -%} A place not described in subsection (c)(1)A.  or B. of this
definition that is open to the public.
    2. {% comment -%} (2) {%- endcomment -%} “Vehicle”.  Has the same meaning as in Ohio R.C. 4501.01.
4. {% comment -%} (d) {%- endcomment %}
...
1. {% comment -%} (a) {%- endcomment -%} No person shall engage in sexual activity for hire.
2. {% comment -%} (b) {%- endcomment -%} No person, with knowledge that the person has tested positive as a
carrier of a virus that causes acquired immunodeficiency syndrome, shall engage
...
1. {% comment -%} (a) {%- endcomment -%} No person, with knowledge of its character or content, shall
recklessly do any of the following:
    1. {% comment -%} (1) {%- endcomment -%} Directly sell, deliver, furnish, disseminate, provide, exhibit,
...
juveniles any material or performance that is obscene or harmful to juveniles;
    2. {% comment -%} (2) {%- endcomment -%} Directly offer or agree to sell, deliver, furnish, disseminate,
...
harmful to juveniles;
    3. {% comment -%} (3) {%- endcomment -%} While in the physical proximity of the juvenile or law enforcement
...
2. {% comment -%} (b) {%- endcomment -%} The following are affirmative defenses to a charge under this section,
that involves material or a performance that is harmful to juveniles but not
obscene:
    1. {% comment -%} (1) {%- endcomment -%} The defendant is the parent, guardian or spouse of the juvenile
involved.
    2. {% comment -%} (2) {%- endcomment -%} The juvenile involved, at the time of the conduct in question, was
...
presented to the juvenile.
    3. {% comment -%} (3) {%- endcomment -%} The juvenile exhibited to the defendant or the defendant’s agent or
...
librarian, clergyman, prosecutor, judge or other proper person.
    2. {% comment -%} (2) {%- endcomment -%} Except as provided in subsection (b)(3) hereof, mistake of age is
...
receiving the information are juveniles.
    2. {% comment -%} (2) {%- endcomment -%} A person remotely transmitting information by means of a method of
...
juveniles in violation of this section if either of the following applies:
        1. {% comment -%} (A) {%- endcomment -%} The person has inadequate information to know or have reason to
believe that a particular recipient of the information or offer is a juvenile.
        2. {% comment -%} (B) {%- endcomment -%} The method of mass distribution does not provide the person the
ability to prevent a particular recipient from receiving the information.
5. {% comment -%} (e) {%- endcomment -%} If any provision of this section, or the application of any provision
of this section to any person or circumstance, is held invalid, the invalidity
does not affect other provisions or applications of this section or related
sections that can be given effect without the invalid provision or
application.  To this end, the provisions are severable.
6. {% comment -%} (f) {%- endcomment -%} Whoever violates this section is guilty of disseminating matter
...
1. {% comment -%} (a) {%- endcomment -%} No person, for the purpose of enabling a juvenile to obtain any
material or gain admission to any performance which is harmful to juveniles
shall do either of the following:
    1. {% comment -%} (1) {%- endcomment -%} Falsely represent that he is the parent, guardian or spouse of such
juvenile;
    2. {% comment -%} (2) {%- endcomment -%} Furnish such juvenile with any identification or document
purporting to show that such juvenile is eighteen years of age or over or
married.
2. {% comment -%} (b) {%- endcomment -%} No juvenile, for the purpose of obtaining any material or gaining
admission to any performance which is harmful to juveniles, shall do either of
the following:
    1. {% comment -%} (1) {%- endcomment -%} Falsely represent that he is eighteen years of age or over or
married;
    2. {% comment -%} (2) {%- endcomment -%} Exhibit any identification or document purporting to show that he
is eighteen years of age or over or married.
3. {% comment -%} (c) {%- endcomment -%} Whoever violates this section is guilty of deception to obtain matter
...
1. {% comment -%} (a) {%- endcomment -%} No person who has custody, control or supervision of a commercial
...
public.
2. {% comment -%} (b) {%- endcomment -%} It is not a violation of subsection (a) hereof if the material in
...
3. {% comment -%} (c) {%- endcomment -%} Whoever violates this section is guilty of displaying matter harmful
...
1. {% comment -%} (a) {%- endcomment -%} No person, by means of a statement, solicitation, or offer in a print
...
activity.
2. {% comment -%} (b) {%- endcomment -%} Whoever violates this section is guilty of unlawful advertising of
massage, a misdemeanor of the first degree.
3. {% comment -%} (c) {%- endcomment -%} Nothing in this section prevents the legislative authority of a
...
1. {% comment -%} (a) {%- endcomment -%} As used in this section:
    1. {% comment -%} (1) {%- endcomment -%} “Disseminate” means to post, distribute, or publish on a computer
device, computer network, web site, or other electronic device or medium of
communication.
    2. {% comment -%} (2) {%- endcomment -%} “Image” means a photograph, film, videotape, digital recording or
other depiction or portrayal of a person.
    3. {% comment -%} (3) {%- endcomment -%} “Interactive computer service” has the meaning defined in the
“Telecommunications Act of 1996", 47 U.S.C. 230, as amended.
    4. {% comment -%} (4) {%- endcomment -%} “Internet provider” means a provider of internet service, including
all of the following:
        1. {% comment -%} (A) {%- endcomment -%} Broadband service, however defined or classified by the federal
communications commission;
        2. {% comment -%} (B) {%- endcomment -%} Information service or telecommunication service, both as defined
in the “Telecommunications Act of 1996" 47 U.S.C. 153, as amended.
        3. {% comment -%} (C) {%- endcomment -%} Internet protocol-enabled services, as defined in Ohio R.C.
4927.01.
    5. {% comment -%} (5) {%- endcomment -%} “Mobile service” and “telecommunications carrier” have the meanings
defined in 47 U.S.C. 153, as amended.
    6. {% comment -%} (6) {%- endcomment -%} “Cable service provider” has the same meaning as in Ohio R.C.
1332.01.
    7. {% comment -%} (7) {%- endcomment -%} “Direct-to-home satellite service” has the meaning defined in 47
U.S.C. 303, as amended.
    8. {% comment -%} (8) {%- endcomment -%} “Video service provider” has the same meaning as in Ohio R.C.
1332.21.
    9. {% comment -%} (9) {%- endcomment -%} “Sexual act” means any of the following:
        1. {% comment -%} (A) {%- endcomment -%} Sexual activity;
        2. {% comment -%} (B) {%- endcomment -%} Masturbation;
        3. {% comment -%} (C) {%- endcomment -%} An act involving a bodily substance that is performed for the
purpose of sexual arousal or gratification;
        4. {% comment -%} (D) {%- endcomment -%} Sado-masochistic abuse.
   
2. {% comment -%} (b) {%- endcomment -%} No person shall knowingly disseminate an image of another person if
all of the following apply:
    1. {% comment -%} (1) {%- endcomment -%} The person in the image is eighteen years of age or older;
    2. {% comment -%} (2) {%- endcomment -%} The person in the image can be identified from the image itself or
from information displayed in connection with the image and the offender
supplied the identifying information.
    3. {% comment -%} (3) {%- endcomment -%} The person in the image is in a state of nudity or is engaged in a
sexual act;
    4. {% comment -%} (4) {%- endcomment -%} The image is disseminated without consent from the person in the
image;
    5. {% comment -%} (5) {%- endcomment -%} The image is disseminated with intent to harm the person in the
image.
3. {% comment -%} (c) {%- endcomment -%} This section does not prohibit the dissemination of an image if any of
the following apply:
    1. {% comment -%} (1) {%- endcomment -%} The image is disseminated for the purpose of a criminal
investigation that is otherwise lawful.
    2. {% comment -%} (2) {%- endcomment -%} The image is disseminated for the purpose of, or in connection
with, the reporting of unlawful conduct.
    3. {% comment -%} (3) {%- endcomment -%} The image is part of a news report or commentary or an artistic or
...
work, musical work, motion picture, film, or audiovisual work.
    4. {% comment -%} (4) {%- endcomment -%} The image is disseminated by a law enforcement officer, or a
corrections officer or guard in a detention facility, acting within the scope
of the person’s official duties.
    5. {% comment -%} (5) {%- endcomment -%} The image is disseminated for another lawful public purpose;
    6. {% comment -%} (6) {%- endcomment -%} The person in the image is knowingly and willingly in a state of
...
in which the person does not have a reasonable expectation of privacy.
    7. {% comment -%} (7) {%- endcomment -%} The image is disseminated for the purpose of medical treatment or
examination.
4. {% comment -%} (d) {%- endcomment -%} The following entities are not liable for a violation of this section
solely as a result of an image or other information provided by another person:
    1. {% comment -%} (1) {%- endcomment -%} A provider of interactive computer service;
    2. {% comment -%} (2) {%- endcomment -%} A mobile service;
    3. {% comment -%} (3) {%- endcomment -%} A telecommunications carrier;
    4. {% comment -%} (4) {%- endcomment -%} An internet provider;
    5. {% comment -%} (5) {%- endcomment -%} A cable service provider;
    6. {% comment -%} (6) {%- endcomment -%} A direct-to-home satellite service;
    7. {% comment -%} (7) {%- endcomment -%} A video service provider.
5. {% comment -%} (e) {%- endcomment -%} Any conduct that is a violation of this section and any other section
...
of private sexual images is a misdemeanor of the first degree.
        4. {% comment -%} (D) {%- endcomment -%} If the offender is under eighteen years of age and the person in
the image is not more than five years older than the offender, the offender
shall not be prosecuted under this section.
    2. {% comment -%} (2) {%- endcomment -%} In addition to any other penalty or disposition authorized or
...
under Ohio R.C. Chapter 2981.
        1. {% comment -%} (A) {%- endcomment -%} Any profits or proceeds and any property the person has acquired
...
to have been acquired or maintained as a result of the violation;
        2. {% comment -%} (B) {%- endcomment -%} Any interest in, securities of, claim against, or property or
...
7. {% comment -%} (g) {%- endcomment -%} A victim of a violation of this section may commence a civil cause of
