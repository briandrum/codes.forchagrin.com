...
2. _(b)_ In order to insure the continued use for automobile parking purposes
...
4. _(d)_ "Employees" means the maximum number of employees on any two
successive shifts.
...
clinic
Club, lodge or One space for each four seats in the principal assembly rooms, or one space
...
3. _(c)_ Institutions (as set forth in the schedule in Section 1141.05) may assume that up to, but not more than fifty percent (50%) of their
...
maneuvering space.
2. _(b)_ Uses for which off-street loading facilities are otherwise required
...
2. _(b)_ All off-street parking areas for three or more spaces shall be marked
...
driveways, aisles and other features enumerated in this chapter.  
(Ord. 2019-39. Passed 8-13-19.)
