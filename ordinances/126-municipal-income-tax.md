...
1. {% comment -%} (a) {%- endcomment -%} On all salaries, qualifying wages, commissions and other compensation
earned on and after July 1, 1981, by residents of the Municipality.
2. {% comment -%} (b) {%- endcomment -%} On all salaries, qualifying wages, commissions and other compensation
...
conducted in the Municipality.
    2. {% comment -%} (2) {%- endcomment -%} On the portion of the distributive share of the net profits earned
...
unincorporated business entity not attributable to the Municipality and not
levied against such unincorporated business entity by the Municipality.
5. {% comment -%} (e) {%- endcomment -%} On the portion attributable to the Municipality of the net profits
...
6. {% comment -%} (f) {%- endcomment -%} On the portion attributable to the Municipality pursuant to the terms
of this chapter and including:
    1. {% comment -%} (1) {%- endcomment -%} Royalty income. Income earned by a taxpayer from a royalty
...
interest shall be subject to tax.
    2. {% comment -%} (2) {%- endcomment -%} Employer’s income. The employer’s income derived from finance and 
carrying charges associated with his customers’ accounts receivable.  
(Ord. 1986-33. Passed 7-14-86; Ord. 2005-44.  Passed 7-11-05. )
7. {% comment -%} (g) {%- endcomment -%} Occasional Entrant Rule.
    1. {% comment -%} (1) {%- endcomment -%} A non-resident individual who works in the Municipality twelve or
...
shall be counted as one day worked in the Municipality.
    2. {% comment -%} (2) {%- endcomment -%} Beginning with the thirteenth day, the employer of said individual
...
Municipality in accordance with the requirements of this chapter.  Since the
...
appropriate income tax to the Municipality.
    3. {% comment -%} (3) {%- endcomment -%} The twelve-day occasional entry rule does not apply to entertainers
...
1. {% comment -%} (a) {%- endcomment -%} Multiply the entire net profits by a business allocation percentage to
...
which shall be given equal weight as follows:
    1. {% comment -%} (1) {%- endcomment -%} The average net book value of the real and tangible personal
...
the annual rental thereon by eight.
    2. {% comment -%} (2) {%- endcomment -%} Wages, salaries and other compensation paid during the taxable
...
services are performed.
    3. {% comment -%} (3) {%- endcomment -%} Gross receipts of the business or profession from sales made and
...
2. {% comment -%} (b) {%- endcomment -%} In the event that the foregoing allocation formula does not produce an
...
a substitute method, by applying the following:
    1. {% comment -%} (1) {%- endcomment -%} The net profits allocable to the Municipality from business,
...
attributable to that part of his activities conducted within the Municipality.
    2. {% comment -%} (2) {%- endcomment -%} If the books and records of the taxpayer are used as the basis for
...
Municipality are apportioned with reasonable accuracy.
    3. {% comment -%} (3) {%- endcomment -%} In determining the income allocable to the Municipality from the
...
taxpayer, whether such headquarters is within or without the Municipality.  
(Ord. 1968-730.  Passed 6-18-68; Ord. 2005-44.  Passed 7-11-05.)
...
1. {% comment -%} (a) {%- endcomment -%} All sales of tangible personal property which is delivered within the
Municipality  regardless of where title passes if shipped or delivered from a
stock of goods  within the Municipality.
2. {% comment -%} (b) {%- endcomment -%} All sales of tangible personal property which is delivered within the
...
3. {% comment -%} (c) {%- endcomment -%} All sales of tangible personal property which is shipped from a place
...
1. {% comment -%} (a) {%- endcomment -%} The portion of a net operating loss sustained in any taxable year
...
2. {% comment -%} (b) {%- endcomment -%} The portion of net operating loss sustained shall be allocated to the
Municipality in the same manner as provided herein for allocating net profits
to the Municipality.
3. {% comment -%} (c) {%- endcomment -%} The Administrator shall provide by rules and regulations the manner
...
1. {% comment -%} (a) {%- endcomment -%} Pay or allowance of active members of the Armed Forces of the United
...
activities.
2. {% comment -%} (b) {%- endcomment -%} Poor relief, unemployment insurance benefits, old age pensions or
...
3. {% comment -%} (c) {%- endcomment -%} Proceeds of insurance paid by reason of the death of the insured;
...
4. {% comment -%} (d) {%- endcomment -%} Receipts from seasonal or casual entertainment, amusements, sports
...
5. {% comment -%} (e) {%- endcomment -%} Alimony received.
6. {% comment -%} (f) {%- endcomment -%} Personal earnings of any natural person under eighteen years of age.
7. {% comment -%} (g) {%- endcomment -%} Compensation for personal injuries or for damages to property by way
of insurance or otherwise.
8. {% comment -%} (h) {%- endcomment -%} Interest, dividends and other revenue from intangible property.
9. {% comment -%} (i) {%- endcomment -%} Gains from involuntary conversion, cancellation of indebtedness,
...
10. {% comment -%} (j) {%- endcomment -%} Salaries, wages, commissions and other compensation and net profits,
...
commerce.
11. {% comment -%} (k) {%- endcomment -%} Salaries, wages, commissions and other compensation and net profits,
...
12. {% comment -%} (l) {%- endcomment -%} Parsonage allowance, to the extent of the rental allowance or rental
...
1. {% comment -%} (a) {%- endcomment -%} The aggregate amounts of salaries, wages, commissions and other
...
2. {% comment -%} (b) {%- endcomment -%} The amount of the tax imposed by this chapter on such earnings and
profits; and
3. {% comment -%} (c) {%- endcomment -%} Such other pertinent statements, information returns or other
...
1. {% comment -%} (a) {%- endcomment -%} Filing of consolidated returns may be permitted or required in
...
Municipality.
2. {% comment -%} (b) {%- endcomment -%} In the case of a corporation that carried on transactions with its
...
1. {% comment -%} (a) {%- endcomment -%} Where necessary, an amended return must be filed in order to report
...
2. {% comment -%} (b) {%- endcomment -%} Within three months from the final determination of any federal tax
...
1. {% comment -%} (a) {%- endcomment -%} The taxpayer making a return shall, at the time of filing thereof, pay
to the Administrator the amount of taxes shown as due thereon; provided,
however, that:
    1. {% comment -%} (1) {%- endcomment -%} Where any portion of the tax so due shall have been deducted at
the source pursuant to the provisions of Section 126.1302 hereof; or
    2. {% comment -%} (2) {%- endcomment -%} Where any portion of such tax shall have been paid by the taxpayer
pursuant to the provisions of Section 126.1303 hereof; or
    3. {% comment -%} (3) {%- endcomment -%} Where an income tax has been paid on the same income to another
municipality;
...
2. {% comment -%} (b) {%- endcomment -%} A taxpayer who has overpaid the amount of tax to which the
...
(Ord.1971-850. Passed 12-7-71.)
3. {% comment -%} (c) {%- endcomment -%} If any employer which is liable for tax obligations imposed by this
...
for the payment of such taxes, interest and penalty.  
(Ord.1986-33. Passed 7-14-86.)
...
1. {% comment -%} (a) {%- endcomment -%} In accordance with rules and regulations prescribed by the
...
(Ord. 2005-44.  Passed 7-11-05.)
2. {% comment -%} (b) {%- endcomment -%} Such returns shall be on a form or forms prescribed or acceptable to
...
fact, been withheld.
3. {% comment -%} (c) {%- endcomment -%} Such employer in collecting such tax shall be deemed to hold the same
...
4. {% comment -%} (d) {%- endcomment -%} No person shall be required to withhold the tax on wages or other
...
(Ord.1971-850. Passed 12-7-71.)
5. {% comment -%} (e) {%- endcomment -%} Manager’s Obligation.
    1. {% comment -%} (1) {%- endcomment -%} Every manager is deemed to be a trustee of the Municipality in
...
determining employee payments or credits.
    2. {% comment -%} (2) {%- endcomment -%} All managers shall be personally liable to the extent of the tax,
...
required under this chapter.
    3. {% comment -%} (3) {%- endcomment -%} No change in structure by an employer, including a fundamental
...
1. {% comment -%} (a) {%- endcomment -%} The declaration required by Section 126.1303 above shall be filed on or before April 15 of each year during the
effective period set forth in Section 126.0502 or within four months of the date the taxpayer becomes subject to tax
for the first time.
2. {% comment -%} (b) {%- endcomment -%} Those taxpayers reporting on a fiscal year basis shall file a
...
1. {% comment -%} (a) {%- endcomment -%} The declaration required by Section 126.1303 hereof shall be filed upon a form furnished by or obtainable from the
...
2. {% comment -%} (b) {%- endcomment -%} The original declaration or any subsequent amendment thereof may be
...
1. {% comment -%} (a) {%- endcomment -%} For failure to pay taxes or estimated taxes due, other than taxes
withheld: ten percent per year, but not less than twenty-five dollars ($25.00).
2. {% comment -%} (b) {%- endcomment -%} For failure to remit taxes withheld from employees: ten percent per
...
dollars ($25.00).
3. {% comment -%} (c) {%- endcomment -%} Notwithstanding the above, no penalties shall be assessed on estimated
...
A penalty shall not be assessed on an additional tax assessment made against
...
1. {% comment -%} (a) {%- endcomment -%} Fails, neglects or refuses to make any return or declaration required
by this chapter; or
2. {% comment -%} (b) {%- endcomment -%} Makes any incomplete, false or fraudulent return; or
3. {% comment -%} (c) {%- endcomment -%} Intentionally or willfully fails, neglects or refuses to pay the tax,
penalties or  interest imposed by this chapter; or
4. {% comment -%} (d) {%- endcomment -%} Fails, neglects or refuses to withhold the tax from his employees or
remit such withholding to the Administrator; or
5. {% comment -%} (e) {%- endcomment -%} Refuses to permit the Administrator, or any duly authorized agent or
...
6. {% comment -%} (f) {%- endcomment -%} Fails to appear before the Administrator and to produce his books,
...
7. {% comment -%} (g) {%- endcomment -%} Refuses to disclose to the Administrator any information with respect
to the income or net profits of a taxpayer; or
8. {% comment -%} (h) {%- endcomment -%} Fails to comply with the provisions of this chapter or any order or
subpoena of the Administrator authorized hereby; or
9. {% comment -%} (i) {%- endcomment -%} Gives to an employer false information as to his true name, correct
...
11. {% comment -%} (k) {%- endcomment -%} Attempts to do anything whatever to avoid the payment of the whole or
...
1. {% comment -%} (a) {%- endcomment -%} When the taxable income of a resident of the Municipality is subject
...
2. {% comment -%} (b) {%- endcomment -%} A claim for credit or refund under this section shall be made in such
...
1. {% comment -%} (a) {%- endcomment -%} First, such part thereof as shall be necessary to defray all expenses
of collecting the tax and of administering and enforcing the provisions of this
chapter shall be paid.
2. {% comment -%} (b) {%- endcomment -%} The balance remaining after payment of the expenses referred to in
...
1. {% comment -%} (a) {%- endcomment -%} Preparation of Return by Administrator. If any taxpayer fails to file
...
such person
2. {% comment -%} (b) {%- endcomment -%} Execution of Return by Administrator. If any taxpayer fails to file a
...
otherwise.
3. {% comment -%} (c) {%- endcomment -%} Assessment of a Taxpayer by Administrator. The Administrator may
...
4. {% comment -%} (d) {%- endcomment -%} Status of Executed Returns and Assessments. Any return executed by or
...
5. {% comment -%} (e) {%- endcomment -%} Limitation of Prosecutions. Neither the Tax Administrator’s execution
...
1. {% comment -%} (a) {%- endcomment -%} A Board of Review, consisting of the Mayor, or the Mayor’s designee,
...
2. {% comment -%} (b) {%- endcomment -%} Any person dissatisfied with any ruling or decision of the
...
3. {% comment -%} (c) {%- endcomment -%} Any person dissatisfied with any ruling or decision of the Board of
...
1. {% comment -%} (a) {%- endcomment -%} This chapter shall continue effective insofar as the levy of taxes is
...
126.1506 and
126.1507 hereof.
2. {% comment -%} (b) {%- endcomment -%} Annual returns due for all or any part of the last effective year of
