...
1. {% comment -%} (a) {%- endcomment -%} (Editor’s note: Former subsection (a) was repealed by Ordinance 2006-
12, passed March 13, 2006.)
2. {% comment -%} (b) {%- endcomment -%} South Main Street. West side from Washington St. south approximately
200 feet.
3. {% comment -%} (c) {%- endcomment -%} Plaza Drive. South side from Main St. to Pleasant Dr.
4. {% comment -%} (d) {%- endcomment -%} Bell Street. South side from Main St. east to the east drive to the
shopping center.
5. {% comment -%} (e) {%- endcomment -%} Pleasant Drive. West side about thirty-five feet south of Bell St. to
about fifty feet north of the plaza.
6. {% comment -%} (f) {%- endcomment -%} (Editor’s note: Former subsection (f) was repealed by Ordinance 2006-
12, passed March 13, 2006.)
7. {% comment -%} (g) {%- endcomment -%} South Franklin. West side from Washington St. south to Center St.
8. {% comment -%} (h) {%- endcomment -%} West Washington. South side from Franklin St. to Walnut St.
9. {% comment -%} (i) {%- endcomment -%} Walnut Street. East side from Center St. north to the Fire Department
drive.
10. {% comment -%} (j) {%- endcomment -%} Center Street. Both sides from Walnut St. east to Franklin Street. 
11. {% comment -%} (k) {%- endcomment -%} River Street. South side from Main St. west approximately 150 feet.
12. {% comment -%} (l) {%- endcomment -%} West Street. Both sides from River St. north to Orange St.
13. {% comment -%} (m) {%- endcomment -%} East Orange Street. North side from about 100 feet east to Main St.
...
1. {% comment -%} (a) {%- endcomment -%} Whenever a vehicle is parked in a metered parking zone where a parking
...
metered parking zone.  (Ord. 2017-74.  Passed 11-13-17.)
2. {% comment -%} (b) {%- endcomment -%} The provisions of this section shall not apply to vehicles parked upon
...
section Saturday afternoon shall not be considered a holiday.  (Ord. 1968-735.
Passed 9-17-68.)
...
1. {% comment -%} (a) {%- endcomment -%} No person shall park or cause, allow or permit to be parked any
...
far as it will go.
2. {% comment -%} (b) {%- endcomment -%} No person shall cause, allow, permit or suffer any vehicle registered
...
3. {% comment -%} (c) {%- endcomment -%} No person shall cause, allow, permit or suffer any vehicle owned or
...
(Ord. 1954-326. Passed 12-13-54.)
4. {% comment -%} (d) {%- endcomment -%} It shall be unlawful for the driver, or the person in charge of a
...
5. {% comment -%} (e) {%- endcomment -%} It shall be unlawful for the driver, or the person in charge of a
...
Deputy Registrar of the State shall be proof of such ownership.  (Ord. 2017-
74.  Passed 11-13-17.)
...
Council.  (Ord. 2017-74.  Passed 11-13-17.)
