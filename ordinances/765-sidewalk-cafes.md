...
1. {% comment -%} (a) {%- endcomment -%} "Abutting property owners and occupants" means any owner or occupant
of property which abuts the subject sidewalk cafe site excluding public right-
of-way.
2. {% comment -%} (b) {%- endcomment -%} "Adjacent sidewalk area" means that portion of the public sidewalk
...
3. {% comment -%} (c) {%- endcomment -%} "Sidewalk cafe" means a place serving food or beverage from a
...
1. {% comment -%} (a) {%- endcomment -%} A completed application;
2. {% comment -%} (b) {%- endcomment -%} A fully dimensioned scale site plan of the area for the proposed
sidewalk cafe;
3. {% comment -%} (c) {%- endcomment -%} A certificate of insurance and endorsement form; and
4. {% comment -%} (d) {%- endcomment -%} The location and description of any tables, materials or equipment
requested to be in the right-of-way.
5. {% comment -%} (e) {%- endcomment -%} Other information shall be provided as required by the Administrator
...
1. {% comment -%} (a) {%- endcomment -%} The operation of a sidewalk cafe is limited to structures which are
sited within ten feet of a public sidewalk, and which are located in the Retail
Business and Central Shopping Districts.
2. {% comment -%} (b) {%- endcomment -%} The operation of a sidewalk cafe shall be located such that the café
...
3. {% comment -%} (c) {%- endcomment -%} The sidewalk cafe may only be located in the adjacent sidewalk area
...
4. {% comment -%} (d) {%- endcomment -%} The sidewalk cafe shall be located five feet from driveways and
alleys, and ten feet from intersections.
5. {% comment -%} (e) {%- endcomment -%} The location of the sidewalk cafe shall be as approved by the
Administrator and shall be exempt from Section 1141.02 requiring off street parking.
6. {% comment -%} (f) {%- endcomment -%} The Administrator shall forward all applications for review by the
...
alcoholic beverages are intended to be served.
    1. {% comment -%} (1) {%- endcomment -%} The Police Chief upon review of the application will sign the
application indicating approval of the permit, or;
    2. {% comment -%} (2) {%- endcomment -%} Approve the permit with conditions, or;
    3. {% comment -%} (3) {%- endcomment -%} Deny the permit. If denied the Police Chief shall transmit in
...
1. {% comment -%} (a) {%- endcomment -%} Each permit issued shall be valid for the calendar year in which it
...
2. {% comment -%} (b) {%- endcomment -%} The permit issued shall be valid only for the permittee and is not
transferable in any manner.
3. {% comment -%} (c) {%- endcomment -%} The permit may be temporarily suspended by the Administrator if the
public interest requires use of the right-of-way for a public event,
construction, repair, or any other public purpose.
4. {% comment -%} (d) {%- endcomment -%} The permit is specifically limited to the area approved or as
...
5. {% comment -%} (e) {%- endcomment -%} The sidewalk and all things placed there shall at all times be
...
6. {% comment -%} (f) {%- endcomment -%} The permittee shall clear any litter from the public sidewalk in the
...
7. {% comment -%} (g) {%- endcomment -%} No signs shall be attached to any furniture, umbrellas, awnings, or
other structure related to the operation of the sidewalk cafe.
8. {% comment -%} (h) {%- endcomment -%} Sidewalk cafes shall be continuously supervised by employees of the
establishment and may be occupied only during the hours of operation of the
establishment.
9. {% comment -%} (i) {%- endcomment -%} Sidewalk cafes shall meet all requirements of the Cuyahoga County
Health Department.
10. {% comment -%} (j) {%- endcomment -%} Tables, chairs, and other materials associated with the sidewalk cafe
...
11. {% comment -%} (k) {%- endcomment -%} The Village of Chagrin Falls has the right to repeal or amend this
...
12. {% comment -%} (l) {%- endcomment -%} Businesses which intend to serve alcoholic beverages at a sidewalk
cafe must meet the following additional requirements
    1. {% comment -%} (1) {%- endcomment -%} The business shall hold a valid Ohio Liquor Control Commission
liquor license.
    2. {% comment -%} (2) {%- endcomment -%} Storage of containers commonly used for dispensing alcoholic
...
alcoholic beverage storage devices are allowed outside on the sidewalk.
    3. {% comment -%} (3) {%- endcomment -%} Sidewalk cafes where alcoholic beverages are served and consumed
...
Ohio Department of Liquor Control liquor license.
    4. {% comment -%} (4) {%- endcomment -%} All service and consumption of alcoholic beverages at sidewalk
cafes shall discontinue by 11 p.m.
    5. {% comment -%} (5) {%- endcomment -%} All alcoholic beverage service providers must also provide food
...
1. {% comment -%} (a) {%- endcomment -%} Furnish a signed statement, with the application, that the permittee
...
the permit.
2. {% comment -%} (b) {%- endcomment -%} Each sidewalk cafe permit holder shall provide proof of liability
