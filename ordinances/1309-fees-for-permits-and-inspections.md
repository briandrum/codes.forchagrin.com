...
1. {% comment -%} (a) {%- endcomment -%} When, in the opinion of the Building Inspector, proper plans and
...
2. {% comment -%} (b) {%- endcomment -%} Any owner, occupant, architect, builder, plumber, carpenter, mason,
...
1. {% comment -%} (a) {%- endcomment -%} A fifty dollar ($50.00) fee shall be paid for any initial certificate
...
2. {% comment -%} (b) {%- endcomment -%} For any inspection for a certificate of occupancy conducted after
occupancy in violation of the code, a one hundred fifty dollar ($150.00) fee
shall be paid.
3. {% comment -%} (c) {%- endcomment -%} There shall be no fee for any renewal of a certificate of occupancy.  
(Ord. 2014-06.  Passed 1-27-14.)
...
1. {% comment -%} (a) {%- endcomment -%} A two hundred fifty dollar ($250.00) fee shall be paid upon
application for a minor subdivision.
2. {% comment -%} (b) {%- endcomment -%} An eight hundred dollar ($800.00) fee shall be paid upon application
