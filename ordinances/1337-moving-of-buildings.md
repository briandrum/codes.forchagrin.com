...
1. {% comment -%} (a) {%- endcomment -%} A description of the building proposed to be moved, giving street
...
2. {% comment -%} (b) {%- endcomment -%} A description of the lot from which the building is to be moved, if
...
3. {% comment -%} (c) {%- endcomment -%} A site and grade plan showing the proposed location of the building
...
4. {% comment -%} (d) {%- endcomment -%} The highways, streets and alleys over, along or across which the
building is proposed to be moved.
5. {% comment -%} (e) {%- endcomment -%} The proposed moving date and hours, including the length of time
estimated in the moving.
6. {% comment -%} (f) {%- endcomment -%} Photographs of all the elevations of the building.
7. {% comment -%} (g) {%- endcomment -%} A traffic and utilities control plan, indicating number of personnel,
police or utility technicians required and arranged for.
8. {% comment -%} (h) {%- endcomment -%} Any additional information which the C.A.O. finds necessary for a
...
1. {% comment -%} (a) {%- endcomment -%} The first part of the permit shall grant permission only to excavate
and build a new foundation to receive the building or structure which is to be
moved, if within the Municipality.
2. {% comment -%} (b) {%- endcomment -%} The second part of the permit shall grant permission to move the
...
1. {% comment -%} (a) {%- endcomment -%} A cash bond in the minimum amount of five thousand dollars ($5,000)
...
2. {% comment -%} (b) {%- endcomment -%} The permit holder shall carry liability insurance, protecting the
...
3. {% comment -%} (c) {%- endcomment -%} If the building is located within the Municipality, there shall be
...
4. {% comment -%} (d) {%- endcomment -%} Where utility companies supplying service to the Municipality will be
...
1. {% comment -%} (a) {%- endcomment -%} The application requirements of the Building, Plumbing, Electrical,
Heating and Zoning Codes will be met by the building in its proposed new
location.
2. {% comment -%} (b) {%- endcomment -%} The application requirements and the necessary fee or deposit
requirements have been complied with.
3. {% comment -%} (c) {%- endcomment -%} The building is of such physical dimensions and of such condition as
to permit its movement without endangering persons or property, in the
Municipality.
4. {% comment -%} (d) {%- endcomment -%} The building is not in such a state of deterioration or disrepair or
otherwise structurally unsafe so that it may be moved without endangering
persons and property in the Municipality.
5. {% comment -%} (e) {%- endcomment -%} If the removal location is in the Municipality, the building is
structurally safe and fit for the purpose for its intended use upon the new
location.
6. {% comment -%} (f) {%- endcomment -%} The applicant’s equipment is safe and persons and property will not
be endangered by its use.
7. {% comment -%} (g) {%- endcomment -%} There exists no other condition which might endanger persons or
