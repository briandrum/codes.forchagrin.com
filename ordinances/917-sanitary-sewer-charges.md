...
1. {% comment -%} (a) {%- endcomment -%} "Sewerage system" or "system" means the sanitary sewerage system of
...
2. {% comment -%} (b) {%- endcomment -%} "Sanitary sewage" means the waste from water closets, urinals,
...
an industrial waste.
3. {% comment -%} (c) {%- endcomment -%} "Acceptable industrial wastes" means liquid organic waste materials
...
4. {% comment -%} (d) {%- endcomment -%} "Nonacceptable industrial wastes" means liquid wastes in which are
...
1. {% comment -%} (a) {%- endcomment -%} The charge to be made shall be computed on the basis of the quantity
...
2. {% comment -%} (b) {%- endcomment -%} Premises located outside the corporate limits of the Municipality
...
effect until modified by Council.  (Ord.  2020-08.  Passed 3-9-20.)
3. {% comment -%} (c) {%- endcomment -%} Any sewage bill unpaid after January 30, April 30, July 30 or October
30 of any year shall incur a penalty of ten percent (10%) of the total unpaid
balance due.  
(Ord. 1985-7.  Passed 2-11-85.)
4. {% comment -%} (d) {%- endcomment -%} On premises using water supplied from sources other than the water
...
5. {% comment -%} (e) {%- endcomment -%} In the event that any premises discharges industrial waste either
...
6. {% comment -%} (f) {%- endcomment -%} In the event the Superintendent of Services shall be satisfied that a
...
7. {% comment -%} (g) {%- endcomment -%}  Connection or tap charge for initial connection to the sewerage
...
8. {% comment -%} (h) {%- endcomment -%} In the event any premises are located outside the corporate limits of
...
effect until modified by Council.  (Ord. 2020-08.    Passed 3-9-20.)
9. {% comment -%} (i) {%- endcomment -%} In addition to any existing connection or tap charge paid pursuant to
...
Village.  
(Ord.  2018-80.  Passed 12-11-18.)
10. {% comment -%} (j) {%- endcomment -%} Owners of property always remain responsible to the Municipality to
...
1. {% comment -%} (a) {%- endcomment -%} Collection of Unpaid Charges. Such sewer charge levied pursuant to
...
2. {% comment -%} (b) {%- endcomment -%} Leased Lots. In the case of leased lots, parcels of land or premises
